      ...
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-12">
          <Reveal className="lg:col-span-6">
            <p className="mb-4 text-xs font-semibold uppercase tracking-[0.12em] text-brand-700">B2B SaaS za edukaciju</p>
          ...
          <Reveal className="lg:col-span-6" delay={0.08}>
            <Card className="relative overflow-hidden border-brand-gray-200 p-6 sm:p-8">
              ...
              <p className="text-xs font-semibold uppercase tracking-[0.12em] text-brand-700">Dashboard preview</p>
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-xl border border-surface bg-soft p-4">
                  ...
                  <div className="mt-2 flex items-center gap-2 text-sm font-medium">
                    <span className="rounded-full bg-brand-500/20 px-2 py-1 text-brand-700">PENDING</span>
                    <span className="rounded-full bg-emerald-500/20 px-2 py-1 text-emerald-600">ACTIVE</span>
                  </div>
                </div>
              </div>
            </Card>
